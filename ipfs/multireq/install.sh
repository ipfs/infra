...
if [ "rebuild$rebuild" == "rebuild1" ]; then
  ...
  echo "multireq docker image changed"
fi

if [ "restart$restart" == "restart1" ]; then
  echo "multireq restarting"
